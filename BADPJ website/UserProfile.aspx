<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserProfile.aspx.cs" Inherits="BADPJ_website.UserProfile" %>
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-9 col-lg-8 cus-mar">
                        <div class="single-content">
                                ...
                                <div class="single-box">
                                    <ul>
                                        <li>
                                            <span>Username</span>
                                            <span>:</span>
                                            <asp:Label ID="lbl_UserProfile" runat="server" Font-Bold="True" Text=""></asp:Label>
                                        </li>
                                        
                                    </ul>
                                    <a href="UpdateUserProfile.aspx"><img src="assets/images/icon/update-btn.png" alt="icon"></a>
                                </div>
                            </div>
                                ...
                                <div class="single-box">
                                    <ul>
                                        <li>
                                            <span>Email</span>
                                            <span>:</span>
                                            <asp:Label ID="lbl_CustomerEmailProfile" runat="server" Text="" ></asp:Label>
                                        </li>
                                    </ul>
                                    <a href="UpdateUserProfile.aspx"><img src="assets/images/icon/update-btn.png" alt="icon"></a>
                                </div>
                                ...
                                <div class="single-box">
                                    <ul>
                                        <li>
                                            <span>Phone</span>
                                            <span>:</span>
                                            <asp:Label ID="lbl_Phone_NoProfile" runat="server" Text="" ></asp:Label>
                                        </li>
                                    </ul>
                                    <a href="UpdateUserProfile.aspx"><img src="assets/images/icon/update-btn.png" alt="icon"></a>
                                </div>
                                ...
                                <div class="single-box">
                                    <ul>
                                        <li>
                                            <span>Password</span>
                                            <span>:</span>
                                            <asp:Label ID="lbl_PasswordProfile"  runat="server"></asp:Label> 
                                        </li>
                                    </ul>
                            ...
                            <div class="head-area mt-5 d-flex align-items-center justify-content-between">
                                <asp:Button ID="btn_UserUpdateProfile" runat="server" Text="Update" class="cmn-btn" OnClick="btn_UserUpdateProfile_Click" />
                            </div>
                        </div>
                    </div>
                </div>
