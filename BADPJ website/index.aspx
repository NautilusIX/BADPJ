<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" EnableSessionState="True" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="BADPJ_website.index" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <div class="col-xl-8 col-md-8">
                            <div class="main-content">
                                <div class="top-area section-text text-center">
                                    <h5 class="sub-title">Esport coaching Platform</h5>
                                    <h1 class="title">Take your game to the next level</h1>
                    ...
                    <div class="row cus-mar align-items-center">
                        <div class="col-lg-4 col-md-6">
                            <div class="single-area text-center">
                                <div class="icon-area">
                                    <img src="assets/images/icon/explore-now-icon-1.png" alt="icon">
                                </div>
                                <div class="text-area">
                                    <p class="mdr">Be a</p>
                                    <h5>COACHES</h5>
                                </div>
                                <a href="coachregister.aspx" class="cmn-btn">ENROLL</a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="single-area text-center">
                                <div class="icon-area">
                                    <img src="assets/images/icon/explore-now-icon-2.png" alt="icon">
                                </div>
                                <div class="text-area">
                                    <p class="mdr">LIVE 1 TO 1</p>
                                    <h5>COACHING</h5>
                                </div>
                                <a href="register.aspx" class="cmn-btn">BOOK NOW</a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="single-area text-center">
                                <div class="icon-area">
                                    <img src="assets/images/icon/explore-now-icon-3.png" alt="icon">
                                </div>
                                <div class="text-area">
                                    <p class="mdr">EVENTS &amp; DISCORD</p>
                                    <h5>COMMUNITY</h5>
                                </div>
                                <a href="register.aspx" class="cmn-btn">JOIN US</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Explore our Coaches start -->
    <section class="explore-coaches">
        <div class="overlay pt-120 pb-12h0">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="section-header text-center">
                            <h5 class="sub-title">IMPROVE WITH COURSES & COACHES</h5>
                            <h2 class="title">Explore our Coaches</h2>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="swiper-container explore-slider">
                            <div class="swiper-wrapper">

                                <div class="swiper-slide">
                                    <img src="assets/images/VAL.jpeg" alt="image" />
                                </div>
                                <div class="swiper-slide">
                                    <img src="assets/images/OW.jpeg" alt="image" />
                                </div>
                                <div class="swiper-slide">
                                    <img src="assets/images/PUBG.jpeg" alt="image" />
                                </div>
                                <div class="swiper-slide">
                                    <img src="assets/images/FORTNITE.jpeg" alt="image" />
                                </div>
                                <div class="swiper-slide">
                                    <img src="assets/images/APEX.jpeg" alt="image" />
                                </div>
                                <div class="swiper-slide">
                                    <img src="assets/images/CSGO.jpeg" alt="image" />
                                </div>
                                <div class="swiper-slide">
                                    <img src="assets/images/COD.jpeg" alt="image" />
                                </div>
                                <div class="swiper-slide">
                                    <img src="assets/images/MINECRAFT.jpeg" alt="image" />
                                </div>
                            </div>
    ...
    <!-- Explore our Coaches end -->

    <!-- How it works start -->
    <section class="how-works second">
        <div class="overlay pt-120 pb-120">
            <div class="container wow fadeInUp">
                ...
                <div class="popup-section justify-content-center text-center">
                    <h4>see how it works</h4>
                    <div class="popup-area pt-120 pb-120">
            ...
            <div class="container">
                <div class="main-content">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-xl-6 cus-mar">
                            <div class="section-text">
                                <h5 class="sub-title">Why Choose Us</h5>
                                <h2 class="title">Make your game play shine</h2>
                            ...
                            <a href="register.aspx" class="cmn-btn alt">Join Now</a>
                        </div>
                        <div class="col-xl-6 res-mar">
                            <div class="row align-items-center">
                                <div class="col-6 cus-mar">
                                    <div class="single-item">
                                        <div class="thumb">
                                            <img src="assets/images/icon/choose-us-icon-1.png" alt="icon">
                                        </div>
                                        <h5>Get mentored by the Best in the Game.</h5>
                                    </div>
                                    <div class="single-item">
                                        <div class="thumb">
                                            <img src="assets/images/icon/choose-us-icon-2.png" alt="icon">
                                        </div>
                                        <h5>Experience the grind of a Pro.</h5>
                                    </div>
                                    <div class="single-item">
                                        <div class="thumb">
                                            <img src="assets/images/icon/choose-us-icon-3.png" alt="icon">
                                        </div>
                                ...
                                <div class="col-6 cus-mar">
                                    <div class="single-item">
                                        <div class="thumb">
                                            <img src="assets/images/icon/choose-us-icon-4.png" alt="icon">
                                        </div>
                                        <h5>Compete in Pro Tournaments.</h5>
                                    </div>
                                    <div class="single-item">
                                        <div class="thumb">
                                            <img src="assets/images/icon/choose-us-icon-5.png" alt="icon">
                                        </div>
        ...
        <div class="overlay pb-120">
            <div class="container">
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-7">
                        <div class="section-header text-center">
                            <h5 class="sub-title">You have a Questions</h5>
                            <h3 class="title">We have answers</h3>
                            <p>If you haven’t found your answer to your questions, Use the ChatBots</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseLeftOne" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <p>GetGud is a platform for both Players and Coaches to get good or to help others get good</p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapseLeftTwo" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <p>Wait for a response from the coach that you have ordered from</p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapseLeftThree" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <p>We have 4 tiers of discounts!! Spend $100 and get 1% discount, $200 to get 2%, $300 for 3% and lastly $500 to get 5%! </p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapseLeftFour" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <p>We have many happy customers and are working with big organisations as well! Feel free to contact us for any other questions.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                ...
                <div class="main-content">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-lg-6">
                            <div class="text-area">
                                <div class="section-text">
                                    <h2 class="title">Improve Your  Skill Now!</h2>
                                    <p>Enjoy Your Gaming Experience More</p>
                                </div>
                                <a href="register.aspx" class="cmn-btn">Join Now</a>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="sec-image">
                                <img src="assets/images/banner-illus.png" alt="image">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="testimonials-carousel">
                            <div class="single-slide">
                                <div class="single">
                                    <div class="info-area">
                                        <p class="xlr">‘’GetGud is awesome! Had a great session with 321 and got to learn a lot from a single workshop.’’</p>
                                        <div class="bottom d-flex align-items-center">
                                            <div class="img-area">
                                                <img src="assets/images/icon/check.png" alt="image">
                                            </div>
                                            <p>123</p>
                                            <span>Valorant</span>
                                        </div>
